        ...
        <div className="main">
            <div className="main-nav">
                ...
                <div className="main-nav-buttons">
                    ...
                    <Link to="/login"><Button className="mnb-1">Login / Signup</Button></Link>
                </div>}
                {loggedIn &&
                    <Button className="mnb-1">Profile</Button>                    
                }
            </div>
            <div className="main-body">
                <div className="body-desc">
                    ...
                    <Link to="/register"><Button className="join" onClick={() => {axios.get('http://localhost:3500/test')}}>Join Now !</Button></Link>
                </div>
